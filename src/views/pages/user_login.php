...
.auth-form h2 { text-align: center; color: #003366; margin-bottom: 20px; font-size: 1.75rem; font-weight: 700; }
...
.auth-message { padding: 10px; border-radius: 5px; margin-bottom: 15px; text-align: center; font-weight: 500; }
...
<div class="auth-form">
    ...
    <form action="index.php?page=user_login_process" method="POST">
    ...
    <div class="auth-link">
        <p>Don't have an account? <a href="index.php?page=user_register">Register here</a></p>
    </div>
</div>