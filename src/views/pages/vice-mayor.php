<?php
$name = $official['name'] ?? 'HON. [Vice Mayor’s Name]';
$message = $official['message'] ?? '[Profile and responsibilities of the Vice Mayor.]';
...
<div class="page-header">
    <h2 class="uppercase tracking-wider">The Municipal Vice Mayor</h2>
</div>
...
<div class="container mx-auto max-w-5xl px-4 py-16">
    <div class="bg-white rounded-xl shadow-2xl overflow-hidden md:flex">
        ...
        <div class="md:w-3/5 p-10">
            <h2 class="text-3xl font-bold text-gray-800 mb-5">Message from the Vice Mayor</h2>
            <div class="prose prose-lg text-gray-600 leading-relaxed">
                <p><?php echo nl2br(htmlspecialchars($message)); ?></p>
            </div>
            <div class="mt-10 border-t border-gray-200 pt-6">
                <h3 class="text-2xl font-bold text-gray-800"><?php echo htmlspecialchars($name); ?></h3>
                <p class="text-lg text-gray-500"><em>Municipal Vice Mayor</em></p>
            </div>
        </div>
